    ...
    <>
      <div className="text-container ptb-100">
        <div className="container">
          ...
          <h2 className="mb-3">
            Agreement between User and www.adcrestmedia.com
          </h2>
          <p className="mb-4">
            Welcome to www.adcrestmedia.com. The www.adcrestmedia.com website
            (the "Site") is comprised of various web pages operated by Adcrest
            Media ("Adcrest"). www.adcrestmedia.com is offered to you
            ...
            www.adcrestmedia.com constitutes your agreement to all such Terms.
            Please read these terms carefully, and keep a copy of them for your
            reference.
          </p>
          <p className="mb-4">
            www.adcrestmedia.com is a business Site. The purpose of this website
            is to provide information regarding Adcrest Media and share general
            industry information. This site is a promotional website, designed
            to promote Adcrest.
          </p>
          <h2 className="mb-3">Privacy</h2>
          <p className="mb-4">
            Your use of www.adcrestmedia.com is subject to Adcrest's Privacy
            Policy. Please review our Privacy Policy, which also governs the
            Site and informs users of our data collection practices.
          </p>
          <h2 className="mb-3">Electronic Communications</h2>
          <p className="mb-4">
            Visiting www.adcrestmedia.com or sending emails to Adcrest
          ...
          <h2 className="mb-3">Children Under 13</h2>
          <p className="mb-4">
            Adcrest does not knowingly collect, either online or offline,
            personal information from persons under the age of 13. If you are
            under 18, you may use www.adcrestmedia.com only with permission of a
            parent or guardian.
          </p>
          <h2 className="mb-3">
          ...
          <p className="mb-4">
            www.adcrestmedia.com may contain links to other websites ("Linked
            Sites"). The Linked Sites are not under the control of Adcrest and
            Adcrest is not responsible for the contents of any Linked Site,
            including without limitation any link contained in a Linked Site, or
            any changes or updates to a Linked Site. Adcrest is providing these
            links to you only as a convenience, and the inclusion of any link
            does not imply endorsement by Adcrest of the site or any association
            with its operators.
          </p>
          <p className="mb-4">
            Certain services made available via www.adcrestmedia.com are
            delivered by third party sites and organizations. By using any
            product, service or functionality originating from the
            www.adcrestmedia.com domain, you hereby acknowledge and consent that
            Adcrest may share such information and data with any third party
            with whom Adcrest has a contractual relationship to provide the
            requested product, service or functionality on behalf of
            www.adcrestmedia.com users and customers.
          </p>
          <h2 className="mb-3">
          ...
          <p className="mb-4">
            ...
            to access and use www.adcrestmedia.com strictly in accordance with
            these terms of use. As a condition of your use of the Site, you
            warrant to Adcrest that you will not use the Site for any purpose
            ...
            available or provided for through the Site. All content included as
            part of the Service, such as text, graphics, logos, images, as well
            as the compilation thereof, and any software used on the Site, is
            the property of Adcrest or its suppliers and protected by copyright
            ...
            of the content, in whole or in part, found on the Site. Adcrest
            ...
            content without the express written permission of Adcrest and the
            ...
            express or implied, to the intellectual property of Adcrest or our
            licensors except as expressly authorized by these Terms.
          </p>

          <h2 className="mb-3">Use of Communication Services</h2>
          <p className="mb-4">
            ...
            privacy and publicity) of others; publish, post, upload, distribute
            ...
            operation of another’s computer; advertise or offer to sell or buy
            any goods or services for any business purpose, unless such
            Communication Service specifically allows such messages; conduct or
            ...
            regulations. Adcrest has no obligation to monitor the Communication
            Services. However, Adcrest reserves the right to review materials
            posted to a Communication Service and to remove any materials in its
            sole discretion. Adcrest reserves the right to terminate your access
            to any or all of the Communication Services at any time without
            notice for any reason whatsoever. Adcrest reserves the right at all
            ...
            materials, in whole or in part, in Adcrest’s sole discretion. Always
            use caution when giving out any personally identifying information
            about yourself or your children in any Communication Service.
            Adcrest does not control or endorse the content, messages or
            information found in any Communication Service and, therefore,
            Adcrest specifically disclaims any liability with regard to the
            ...
            not authorized Adcrest spokespersons, and their views do not
            necessarily reflect those of Adcrest. Materials uploaded to a
          ...
          <h2 className="mb-3">
            Materials Provided to www.adcrestmedia.com or Posted on Any Adcrest
            Web Page
          </h2>
          <p className="mb-4">
            Adcrest does not claim ownership of the materials you provide to
            www.adcrestmedia.com (including feedback and suggestions) or post,
            upload, input or submit to any Adcrest Site or our associated
            services (collectively "Submissions"). However, by posting,
            uploading, inputting, providing or submitting your Submission you
            are granting Adcrest, our affiliated companies and necessary
          ...
          <p className="mb-4">
            ...
            Submission, as provided herein. Adcrest is under no obligation to
            post or use any Submission you may provide and may remove any
            Submission at any time in Adcrest's sole discretion.
          </p>
          <p className="mb-4">
          ...
          <h2 className="mb-3">Third Party Accounts</h2>
          <p className="mb-4">
            You will be able to connect your Adcrest account to third party
            accounts. By connecting your Adcrest account to your third party
          ...
          <h2 className="mb-3">International Users</h2>
          <p className="mb-4">
            The Service is controlled, operated and administered by Adcrest from
            ...
            all local laws. You agree that you will not use the Adcrest Content
            accessed through www.adcrestmedia.com in any country or in any
          ...
          <p className="mb-4">
            You agree to indemnify, defend and hold harmless Adcrest, its
            ...
            laws, rules or regulations. Adcrest reserves the right, at its own
            ...
            fully cooperate with Adcrest in asserting any available defenses.
          </p>

          <h2 className="mb-3">Class Action Waiver</h2>
          <p className="mb-4">
            ...
            AGAINST THE OTHER. Further, unless both you and Adcrest agree
          ...
          <h2 className="mb-3">Liability Disclaimer</h2>
          <p className="mb-4">
            ...
            Adcrest MEDIA AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR
            CHANGES IN THE SITE AT ANY TIME.
          </p>
          <p className="mb-4">
            Adcrest MEDIA AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
            ...
            WARRANTY OR CONDITION OF ANY KIND. Adcrest MEDIA AND/OR ITS
          ...
          <p className="mb-4">
            ...
            Adcrest MEDIA AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT,
            ...
            Adcrest MEDIA OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE
          ...
          <h2 className="mb-3">Termination/Access Restriction</h2>
          <p className="mb-4">
            Adcrest reserves the right, in its sole discretion, to terminate
            ...
            by law, this agreement is governed by the laws of the State of New
            York and you hereby consent to the exclusive jurisdiction and venue
            of courts in New York in all disputes arising out of or relating to
          ...
          <p className="mb-4">
            ...
            relationship exists between you and Adcrest as a result of this
            agreement or use of the Site. Adcrest's performance of this
            agreement is subject to existing laws and legal process, and nothing
            contained in this agreement is in derogation of Adcrest's right to
            ...
            provided to or gathered by Adcrest with respect to such use. If any
          ...
          <p className="mb-4">
            ...
            entire agreement between the user and Adcrest with respect to the
            ...
            and Adcrest with respect to the Site. A printed version of this
          ...
          <p className="mb-4">
            Adcrest reserves the right, in its sole discretion, to change the
            Terms under which www.adcrestmedia.com is offered. The most current
            version of the Terms will supersede all previous versions. Adcrest
          ...
          <p className="mb-4">
            Adcrest welcomes your questions or comments regarding the Terms:
          </p>
          <address>
            <strong>Adcrest Media</strong>
            <br />
            30 N Gould St Ste R<br />
            Sheridan, WY 82801
            <br />
            <strong>Email Address:</strong> info@adcrestmedia.com
            <br />
            <strong>Telephone number:</strong> 825-889-7071
          </address>
        </div>
      </div>
    </>
